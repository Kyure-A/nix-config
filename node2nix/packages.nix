...
let
  sources = {
    ...
    "@google/genai-1.5.0" = {
      ...
      version = "1.5.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@google/genai/-/genai-1.5.0.tgz";
        sha512 = "N/UhGPcKwYw4tD/fERrNQMeHh3yiUDXhJ5f94HSMV7LhkU19IMFSqtXjek6nSpgM/YDJGBYw/MoHVLjfWhmdmQ==";
      };
    };
    ...
    "@types/node-18.19.111" = {
      ...
      version = "18.19.111";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-18.19.111.tgz";
        sha512 = "90sGdgA+QLJr1F9X79tQuEut0gEYIfkX9pydI4XGRgvFo9g2JWswefI+WUSUHPYVBHYSEfTEqBxA5hQvAZB3Mw==";
      };
    };
...
in
{
  ...
  "@mariozechner/claude-bridge" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."@google/genai-1.5.0"
      sources."@modelcontextprotocol/sdk-1.12.2"
      sources."@types/node-18.19.111"
